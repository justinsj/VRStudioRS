...
$auth["admin"][] = "jdsanjuan";
$auth["session"] = "php";
$auth["type"] = "config";
$auth["user"]["jdsanjuan"] = "jdsanjuan";
$auth["user"]["demo"] = "demo";
//INSERT INTO `mrbs_users`(`id`,`level`,`name`,`password_hash`,`email`)VALUES(3,1,'name','pass','email');
$mrbs_company = "Lautriv-Max (VR Studio)";
